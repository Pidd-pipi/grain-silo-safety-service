...
func (a *inspectionAPI) handleList(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPost:
		...
		if err != nil {
			...
			case errors.Is(err, domain.ErrSiloRejected), errors.Is(err, domain.ErrFindingEmpty):
				status = http.StatusConflict
			case errors.Is(err, ErrInspectionBusy), errors.Is(err, ErrInspectionInFlight):
